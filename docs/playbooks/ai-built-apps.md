...
5. **Run automated tools.** Use tools built to catch what humans miss:
   - **[Bastion](https://github.com/absastreon/bastion)** — security checker for AI-built apps (15 checks, AI-generated fix prompts)
   - **[Skylos](https://github.com/duriantaco/skylos)** — dead code detection (finds unused security functions)
...
*Generated by [Bastion](https://github.com/absastreon/bastion) — security checker for AI-built apps.*
